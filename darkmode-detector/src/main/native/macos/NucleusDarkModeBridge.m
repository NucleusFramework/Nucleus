...
Java_dev_nucleusframework_darkmodedetector_mac_NativeDarkModeBridge_nativeIsDark(
...
Java_dev_nucleusframework_darkmodedetector_mac_NativeDarkModeBridge_nativeStartObserving(
    JNIEnv *env, jclass clazz) {
...
JNIEXPORT void JNICALL
Java_dev_nucleusframework_darkmodedetector_mac_NativeDarkModeBridge_nativeStopObserving(
    JNIEnv *env, jclass clazz) {
    if (g_observer != nil) {
