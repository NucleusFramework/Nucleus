...
Java_dev_nucleusframework_darkmodedetector_windows_NativeWindowsBridge_nativeIsDark(
...
Java_dev_nucleusframework_darkmodedetector_windows_NativeWindowsBridge_nativeStartObserving(
    JNIEnv *env, jclass clazz)
{
    (void)env; (void)clazz;
    if (g_running) {
...
/* ------------------------------------------------------------------ */
JNIEXPORT void JNICALL
Java_dev_nucleusframework_darkmodedetector_windows_NativeWindowsBridge_nativeStopObserving(
    JNIEnv *env, jclass clazz)
{
    (void)env; (void)clazz;
    if (!g_running) {
