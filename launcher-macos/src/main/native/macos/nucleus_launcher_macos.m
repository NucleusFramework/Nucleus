...
#define BRIDGE_CLASS "dev/nucleusframework/launcher/macos/NativeMacOsDockMenuBridge"
...
Java_dev_nucleusframework_launcher_macos_NativeMacOsDockMenuBridge_nativeSetDockMenu(
...
JNIEXPORT void JNICALL
Java_dev_nucleusframework_launcher_macos_NativeMacOsDockMenuBridge_nativeClearDockMenu(
    JNIEnv *env, jclass clazz) {
    (void)env; (void)clazz;
