...
Java_dev_nucleusframework_launcher_windows_NativeWindowsBadgeBridge_nativeInitialize(
...
JNIEXPORT jstring JNICALL
Java_dev_nucleusframework_launcher_windows_NativeWindowsBadgeBridge_nativeSetBadgeNumber(
...
JNIEXPORT jstring JNICALL
Java_dev_nucleusframework_launcher_windows_NativeWindowsBadgeBridge_nativeSetBadgeGlyph(
...
JNIEXPORT jstring JNICALL
Java_dev_nucleusframework_launcher_windows_NativeWindowsBadgeBridge_nativeClearBadge(
...
Java_dev_nucleusframework_launcher_windows_NativeWindowsBadgeBridge_nativeUninitialize(
    JNIEnv *env, jclass clazz
) {
    std::lock_guard<std::mutex> lock(g_mutex);
...
JNIEXPORT jstring JNICALL
Java_dev_nucleusframework_launcher_windows_NativeWindowsJumpListBridge_nativeSetProcessAppId(
...
JNIEXPORT jstring JNICALL
Java_dev_nucleusframework_launcher_windows_NativeWindowsJumpListBridge_nativeBeginList(
    JNIEnv *env, jclass clazz, jstring jAumid, jboolean jIsAppx
) {
...
JNIEXPORT jstring JNICALL
Java_dev_nucleusframework_launcher_windows_NativeWindowsJumpListBridge_nativeAppendCategory(
...
JNIEXPORT jstring JNICALL
Java_dev_nucleusframework_launcher_windows_NativeWindowsJumpListBridge_nativeAppendKnownCategory(
...
JNIEXPORT jstring JNICALL
Java_dev_nucleusframework_launcher_windows_NativeWindowsJumpListBridge_nativeAddUserTasks(
    JNIEnv *env, jclass clazz,
    jobjectArray jTitles, jobjectArray jArguments, jobjectArray jDescriptions,
    jintArray jIconTypes, jobjectArray jIconPaths, jintArray jIconIndices,
...
JNIEXPORT jstring JNICALL
Java_dev_nucleusframework_launcher_windows_NativeWindowsJumpListBridge_nativeCommitList(
    JNIEnv *env, jclass clazz
) {
    std::lock_guard<std::mutex> lock(g_jl_mutex);
    if (!g_jumpList) return env->NewStringUTF("No active jump list session");
...
JNIEXPORT jstring JNICALL
Java_dev_nucleusframework_launcher_windows_NativeWindowsJumpListBridge_nativeDeleteList(
    JNIEnv *env, jclass clazz, jstring jAumid, jboolean jIsAppx
) {
    std::lock_guard<std::mutex> lock(g_jl_mutex);
...
Java_dev_nucleusframework_launcher_windows_NativeWindowsTaskbarBridge_nativeGetHwnd(
    ...
    jobject jCallback)
{
    ...
    if (existingState && existingState->buttonsAdded) {
        ...
        if (jCallback) {
            ...
            jclass cbClass = env->FindClass("dev/nucleusframework/launcher/windows/ThumbBarClickListener");
