...
/**
 * Size of the last drawable each window's Metal host presented, keyed by
 ...
 * the new size has been presented, or Core Animation shows the previous
 * drawable stretched to the new bounds and the whole content trembles.
 *
