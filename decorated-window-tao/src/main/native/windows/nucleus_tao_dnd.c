...
Java_dev_nucleusframework_window_tao_ffi_NativeTaoWindowsDndBridge_nativeRegister(
 ...
 */
JNIEXPORT jint JNICALL
Java_dev_nucleusframework_window_tao_ffi_NativeTaoWindowsDndBridge_nativeRevoke(
