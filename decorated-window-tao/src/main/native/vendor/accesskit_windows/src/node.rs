...
impl IRawElementProviderSimple_Impl for PlatformNode_Impl {
    fn ProviderOptions(&self) -> Result<ProviderOptions> {
        // Vendored-fork: ServerSideProvider | UseComThreading — required for
        // out-of-process .NET/PowerShell AutomationPropertyChangedEventHandler
        // clients to receive UiaRaise* events (Chromium/Electron do the same).
        // Upstream accesskit_windows only sets ServerSideProvider.
