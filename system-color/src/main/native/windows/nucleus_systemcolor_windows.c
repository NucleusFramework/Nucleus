...
static void notifyAccentColorChanged(int r, int g, int b) {
    ...
    jclass bridgeClass = (*env)->FindClass(env,
        "dev/nucleusframework/systemcolor/windows/NativeWindowsSystemColorBridge");
    if (bridgeClass != NULL) {
...
Java_dev_nucleusframework_systemcolor_windows_NativeWindowsSystemColorBridge_nativeGetAccentColor(
...
JNIEXPORT jboolean JNICALL
Java_dev_nucleusframework_systemcolor_windows_NativeWindowsSystemColorBridge_nativeIsHighContrast(
...
JNIEXPORT jboolean JNICALL
Java_dev_nucleusframework_systemcolor_windows_NativeWindowsSystemColorBridge_nativeIsAccentColorSupported(
    JNIEnv *env, jclass clazz) {
    (void)env; (void)clazz;
    int r, g, b;
...
Java_dev_nucleusframework_systemcolor_windows_NativeWindowsSystemColorBridge_nativeStartObserving(
    JNIEnv *env, jclass clazz) {
    (void)env; (void)clazz;
...
JNIEXPORT void JNICALL
Java_dev_nucleusframework_systemcolor_windows_NativeWindowsSystemColorBridge_nativeStopObserving(
    JNIEnv *env, jclass clazz) {
    (void)env; (void)clazz;
    if (g_watchThread == NULL) return;
