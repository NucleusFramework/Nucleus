...
static void notifyAccentColorChanged(void) {
    ...
    jclass bridgeClass = (*env)->FindClass(env,
        "dev/nucleusframework/systemcolor/mac/NativeMacSystemColorBridge");
    if (bridgeClass != NULL) {
        if (!isAccentColorSet()) {
...
Java_dev_nucleusframework_systemcolor_mac_NativeMacSystemColorBridge_nativeGetAccentColor(
...
JNIEXPORT jboolean JNICALL
Java_dev_nucleusframework_systemcolor_mac_NativeMacSystemColorBridge_nativeIsHighContrast(
...
JNIEXPORT jboolean JNICALL
Java_dev_nucleusframework_systemcolor_mac_NativeMacSystemColorBridge_nativeIsAccentColorSupported(
    JNIEnv *env, jclass clazz) {
    if (@available(macOS 10.14, *)) {
        return JNI_TRUE;
    }
...
Java_dev_nucleusframework_systemcolor_mac_NativeMacSystemColorBridge_nativeStartObserving(
    JNIEnv *env, jclass clazz) {
...
JNIEXPORT void JNICALL
Java_dev_nucleusframework_systemcolor_mac_NativeMacSystemColorBridge_nativeStopObserving(
    JNIEnv *env, jclass clazz) {
