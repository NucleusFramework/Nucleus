...
nucleusNative {
    macos("nucleus_screencapture")
    linux("nucleus_screencapture")
    windows("nucleus_screencapture")
}

mavenPublishing {
    coordinates("dev.nucleusframework", "nucleus.screen-capture", publishVersion)

    pom {
        name.set("Nucleus Screen Capture")
        description.set("Native, AWT-free screen and window capture (GDI, ScreenCaptureKit, X11, xdg-desktop-portal)")
