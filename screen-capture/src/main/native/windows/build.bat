@echo off
REM Compiles nucleus_screencapture_windows.c into per-architecture DLLs (x64 + ARM64).
...
set "SCRIPT_DIR=%~dp0"
set "SRC=%SCRIPT_DIR%nucleus_screencapture_windows.c"
...
cl /LD /O1 /GS- /nologo ^
    ...
    "%SRC%" ^
    /Fe:"%OUT_DIR_X64%\nucleus_screencapture.dll" ^
    /link kernel32.lib user32.lib gdi32.lib dwmapi.lib
if errorlevel 1 (
