package dev.nucleusframework.systeminfo.linux
...
import dev.nucleusframework.systeminfo.model.CpuInfo
...
internal object LinuxSystemInfo : PlatformSystemInfo {
    ...
    // isLoaded can be true off-Linux: NativeLibraryLoader caches by library name,
    // and every platform ships nucleus_system_info. JNI symbols are class-specific.
    private fun ready(): Boolean = Platform.Current == Platform.Linux && bridge.isLoaded
