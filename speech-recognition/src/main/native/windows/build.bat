...
echo.
echo === Building nucleus_speech.dll (x64) ===
setlocal
call "%VCVARSALL%" x64
if errorlevel 1 (
...
copy /Y "target\x86_64-pc-windows-msvc\release\nucleus_speech.dll" "%OUT_DIR_X64%\nucleus_speech.dll" >nul
popd
endlocal

echo.
echo === Building nucleus_speech.dll (ARM64, optional) ===
if exist "%OUT_DIR_ARM64%\nucleus_speech.dll" del /q "%OUT_DIR_ARM64%\nucleus_speech.dll" 2>nul
setlocal
...
if exist "%OUT_DIR_X64%\nucleus_speech.dll" echo   %OUT_DIR_X64%\nucleus_speech.dll
if exist "%OUT_DIR_ARM64%\nucleus_speech.dll" echo   %OUT_DIR_ARM64%\nucleus_speech.dll
