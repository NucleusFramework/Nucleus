...
echo.
echo === Building nucleus_location.dll (x64) ===
setlocal
call "%VCVARSALL%" x64
if errorlevel 1 (
...
copy /Y "target\x86_64-pc-windows-msvc\release\nucleus_location.dll" "%OUT_DIR_X64%\nucleus_location.dll" >nul
popd
endlocal

echo.
echo === Building nucleus_location.dll (ARM64, optional) ===
if exist "%OUT_DIR_ARM64%\nucleus_location.dll" del /q "%OUT_DIR_ARM64%\nucleus_location.dll" 2>nul
setlocal
...
if exist "%OUT_DIR_X64%\nucleus_location.dll" echo   %OUT_DIR_X64%\nucleus_location.dll
if exist "%OUT_DIR_ARM64%\nucleus_location.dll" echo   %OUT_DIR_ARM64%\nucleus_location.dll
