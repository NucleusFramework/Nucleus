...
static GVariant *build_metadata_locked(void) {
    ...
    snprintf(track_path, sizeof(track_path),
             "/dev/nucleusframework/track/%" G_GUINT64_FORMAT,
             g_track_counter);
...
Java_dev_nucleusframework_media_control_linux_NativeLinuxBridge_nativeConfigure(
...
JNIEXPORT void JNICALL
Java_dev_nucleusframework_media_control_linux_NativeLinuxBridge_nativeSetMetadata(
...
JNIEXPORT void JNICALL
Java_dev_nucleusframework_media_control_linux_NativeLinuxBridge_nativeSetPlaybackState(
...
JNIEXPORT void JNICALL
Java_dev_nucleusframework_media_control_linux_NativeLinuxBridge_nativeSetVolume(
...
Java_dev_nucleusframework_media_control_linux_NativeLinuxBridge_nativeStartListening(
    JNIEnv *env, jclass clazz)
{
    (void)env; (void)clazz;
    pthread_mutex_lock(&g_state_mutex);
...
JNIEXPORT void JNICALL
Java_dev_nucleusframework_media_control_linux_NativeLinuxBridge_nativeStopListening(
    JNIEnv *env, jclass clazz)
{
    (void)env; (void)clazz;
    pthread_mutex_lock(&g_state_mutex);
