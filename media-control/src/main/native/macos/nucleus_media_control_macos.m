...
#define BRIDGE_CLASS "dev/nucleusframework/media/control/macos/NativeMacOsBridge"
...
Java_dev_nucleusframework_media_control_macos_NativeMacOsBridge_nativeConfigure(
...
JNIEXPORT void JNICALL
Java_dev_nucleusframework_media_control_macos_NativeMacOsBridge_nativeSetMetadata(
...
JNIEXPORT void JNICALL
Java_dev_nucleusframework_media_control_macos_NativeMacOsBridge_nativeSetPlaybackState(
...
JNIEXPORT void JNICALL
Java_dev_nucleusframework_media_control_macos_NativeMacOsBridge_nativeSetVolume(
...
Java_dev_nucleusframework_media_control_macos_NativeMacOsBridge_nativeStartListening(
    JNIEnv *env, jclass clazz)
{
    (void)clazz;
...
JNIEXPORT void JNICALL
Java_dev_nucleusframework_media_control_macos_NativeMacOsBridge_nativeStopListening(
    JNIEnv *env, jclass clazz)
{
    (void)env; (void)clazz;
    dispatch_async(dispatch_get_main_queue(), ^{
