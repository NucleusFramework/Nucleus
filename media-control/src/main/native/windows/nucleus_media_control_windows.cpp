...
#define BRIDGE_CLASS "dev/nucleusframework/media/control/windows/NativeWindowsBridge"
...
Java_dev_nucleusframework_media_control_windows_NativeWindowsBridge_nativeConfigure(
...
JNIEXPORT void JNICALL
Java_dev_nucleusframework_media_control_windows_NativeWindowsBridge_nativeSetMetadata(
    JNIEnv *env, jclass,
...
JNIEXPORT void JNICALL
Java_dev_nucleusframework_media_control_windows_NativeWindowsBridge_nativeSetPlaybackState(
...
JNIEXPORT void JNICALL
Java_dev_nucleusframework_media_control_windows_NativeWindowsBridge_nativeSetVolume(
...
Java_dev_nucleusframework_media_control_windows_NativeWindowsBridge_nativeStartListening(
    JNIEnv *, jclass
) {
    std::lock_guard<std::mutex> lock(g_mutex);
...
JNIEXPORT void JNICALL
Java_dev_nucleusframework_media_control_windows_NativeWindowsBridge_nativeStopListening(
    JNIEnv *, jclass
) {
    std::lock_guard<std::mutex> lock(g_mutex);
