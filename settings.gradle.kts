...
include(":service-management-demo")
...
include(":menu-macos")
include(":clipboard-common")
include(":clipboard-macos")
include(":clipboard-linux")
include(":clipboard-windows")
...
include(":scheduler-demo")
include(":system-info-demo")
