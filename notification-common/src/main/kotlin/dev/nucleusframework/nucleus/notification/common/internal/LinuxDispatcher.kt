...
import dev.nucleusframework.nucleus.notification.linux.Notification as LinuxNotification
...
internal class LinuxDispatcher private constructor() : PlatformDispatcher {
    ...
    companion object {
        fun createIfAvailable(): LinuxDispatcher? =
            try {
                Class.forName("dev.nucleusframework.nucleus.notification.linux.LinuxNotificationCenter")
                LinuxDispatcher()
