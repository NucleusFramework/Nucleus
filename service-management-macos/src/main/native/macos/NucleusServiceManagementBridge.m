...
#define BRIDGE_CLASS "dev/nucleusframework/servicemanagement/macos/NativeMacServiceManagementBridge"
...
Java_dev_nucleusframework_servicemanagement_macos_NativeMacServiceManagementBridge_nativeIsAvailable(
...
Java_dev_nucleusframework_servicemanagement_macos_NativeMacServiceManagementBridge_nativeRegister(
...
Java_dev_nucleusframework_servicemanagement_macos_NativeMacServiceManagementBridge_nativeUnregister(
...
Java_dev_nucleusframework_servicemanagement_macos_NativeMacServiceManagementBridge_nativeGetStatus(
    JNIEnv *env, jclass clazz, jint type, jstring jidentifier) {
    (void)clazz;
...
JNIEXPORT jboolean JNICALL
Java_dev_nucleusframework_servicemanagement_macos_NativeMacServiceManagementBridge_nativeOpenSystemSettingsLoginItems(
    JNIEnv *env, jclass clazz) {
    (void)env; (void)clazz;
