#!/bin/bash
# Compiles nucleus_clipboard.m into per-architecture dylibs (arm64 + x86_64).
# Requires macOS 10.13+ (AppKit NSPasteboardTypePNG).
#
...
SRC="$SCRIPT_DIR/nucleus_clipboard.m"
...
LIB_NAME="libnucleus_clipboard.dylib"
