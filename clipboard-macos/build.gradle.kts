...
val buildNativeMacOs by tasks.registering(Exec::class) {
    ...
    val hasPrebuilt =
        nativeResourceDir
            .dir("darwin-aarch64")
            .file("libnucleus_clipboard.dylib")
            .asFile
            .exists()
...
mavenPublishing {
    coordinates("io.github.kdroidfilter", "nucleus.clipboard-macos", publishVersion)

    pom {
        name.set("Nucleus Clipboard macOS")
        description.set("macOS NSPasteboard clipboard backend for Nucleus via JNI")
