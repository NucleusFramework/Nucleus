...
val KdeControlButtonsIcons.ClosePressedFocused: ImageVector
    get() {
        ...
        _ClosePressedFocused = ImageVector.Builder(
            name = "ClosePressedFocused",
            defaultWidth = 20.dp,
            defaultHeight = 20.dp,
            viewportWidth = 20f,
            viewportHeight = 20f
        ).apply {
            path(fill = SolidColor(Color(0xFFD4566A))) {
                moveTo(10f, 10f)
...
private var _ClosePressedFocused: ImageVector? = null
