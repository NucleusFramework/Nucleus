...
#define BRIDGE_CLASS "dev/nucleusframework/notification/macos/NativeMacNotificationBridge"
...
Java_dev_nucleusframework_notification_macos_NativeMacNotificationBridge_nativeRequestAuthorization(
...
JNIEXPORT void JNICALL
Java_dev_nucleusframework_notification_macos_NativeMacNotificationBridge_nativeGetNotificationSettings(
...
JNIEXPORT void JNICALL
Java_dev_nucleusframework_notification_macos_NativeMacNotificationBridge_nativeAddNotificationRequest(
...
JNIEXPORT void JNICALL
Java_dev_nucleusframework_notification_macos_NativeMacNotificationBridge_nativeRemovePendingNotifications(
...
JNIEXPORT void JNICALL
Java_dev_nucleusframework_notification_macos_NativeMacNotificationBridge_nativeRemoveAllPendingNotifications(
    JNIEnv *env, jclass clazz) {
    if (@available(macOS 10.14, *)) {
...
JNIEXPORT void JNICALL
Java_dev_nucleusframework_notification_macos_NativeMacNotificationBridge_nativeGetPendingNotifications(
    JNIEnv *env, jclass clazz, jlong callbackId) {
    if (@available(macOS 10.14, *)) {
        UNUserNotificationCenter *center = [UNUserNotificationCenter currentNotificationCenter];
...
JNIEXPORT void JNICALL
Java_dev_nucleusframework_notification_macos_NativeMacNotificationBridge_nativeRemoveDeliveredNotifications(
    JNIEnv *env, jclass clazz, jobjectArray jIdentifiers) {
    if (@available(macOS 10.14, *)) {
        @autoreleasepool {
            jsize count = (*env)->GetArrayLength(env, jIdentifiers);
...
JNIEXPORT void JNICALL
Java_dev_nucleusframework_notification_macos_NativeMacNotificationBridge_nativeRemoveAllDeliveredNotifications(
    JNIEnv *env, jclass clazz) {
    if (@available(macOS 10.14, *)) {
...
JNIEXPORT void JNICALL
Java_dev_nucleusframework_notification_macos_NativeMacNotificationBridge_nativeGetDeliveredNotifications(
    JNIEnv *env, jclass clazz, jlong callbackId) {
    if (@available(macOS 10.14, *)) {
        UNUserNotificationCenter *center = [UNUserNotificationCenter currentNotificationCenter];
...
JNIEXPORT void JNICALL
Java_dev_nucleusframework_notification_macos_NativeMacNotificationBridge_nativeSetNotificationCategories(
    JNIEnv *env, jclass clazz,
...
JNIEXPORT void JNICALL
Java_dev_nucleusframework_notification_macos_NativeMacNotificationBridge_nativeGetNotificationCategories(
    JNIEnv *env, jclass clazz, jlong callbackId) {
    if (@available(macOS 10.14, *)) {
        UNUserNotificationCenter *center = [UNUserNotificationCenter currentNotificationCenter];
...
JNIEXPORT void JNICALL
Java_dev_nucleusframework_notification_macos_NativeMacNotificationBridge_nativeSetBadgeCount(
...
JNIEXPORT void JNICALL
Java_dev_nucleusframework_notification_macos_NativeMacNotificationBridge_nativeGetBadgeCount(
    JNIEnv *env, jclass clazz, jlong callbackId) {
    if (@available(macOS 13.0, *)) {
...
JNIEXPORT void JNICALL
Java_dev_nucleusframework_notification_macos_NativeMacNotificationBridge_nativeSetDelegate(
