...
mavenPublishing {
    coordinates("dev.nucleusframework", "nucleus.notification-macos", publishVersion)

    pom {
        name.set("Nucleus Notification macOS")
        description.set("macOS UserNotifications API for JVM desktop applications via JNI")
