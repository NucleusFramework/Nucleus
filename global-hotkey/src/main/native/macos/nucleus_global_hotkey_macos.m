...
Java_dev_nucleusframework_globalhotkey_macos_NativeMacOsHotKeyBridge_nativeInit(
...
JNIEXPORT jstring JNICALL
Java_dev_nucleusframework_globalhotkey_macos_NativeMacOsHotKeyBridge_nativeRegister(
...
JNIEXPORT jstring JNICALL
Java_dev_nucleusframework_globalhotkey_macos_NativeMacOsHotKeyBridge_nativeUnregister(
...
Java_dev_nucleusframework_globalhotkey_macos_NativeMacOsHotKeyBridge_nativeShutdown(
    JNIEnv *env, jclass clazz) {
    (void)clazz;
    @autoreleasepool {
