...
Java_dev_nucleusframework_globalhotkey_windows_NativeWindowsHotKeyBridge_nativeInit(
...
JNIEXPORT jstring JNICALL
Java_dev_nucleusframework_globalhotkey_windows_NativeWindowsHotKeyBridge_nativeRegister(
...
JNIEXPORT jstring JNICALL
Java_dev_nucleusframework_globalhotkey_windows_NativeWindowsHotKeyBridge_nativeUnregister(
...
Java_dev_nucleusframework_globalhotkey_windows_NativeWindowsHotKeyBridge_nativeShutdown(
    JNIEnv*, jclass
) {
